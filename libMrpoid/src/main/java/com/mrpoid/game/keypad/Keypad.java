...
//	
//	public static Keypad getInstance1() {
//		if(instance == null){
...
//	public void init(Cont)
	...
	public Keypad(Context c, boolean editMode) {
		this.context = c;
...
//		setLayouter(new DefKeyLayouter());
	...
	private void initButtonSize() {
		DisplayMetrics metrics = MrpRunner.getResources().getDisplayMetrics();
		
		float base = MrpRunner.getResources().getDimension(R.dimen.dp1);
	...
	public File getXml(boolean isLandscape, int mode) {
		return MrpRunner.getContext().getFileStreamPath(isLandscape ? 
