...
public class EmulatorService extends AppProcessService {
	...
	private void handleStart(Intent intent) {
		...
		if(intent==null)
		{
			UIUtils.toastMessage(this,"intent null");
			return;
		}
		if (ACTION_STARTMRP.equals(intent.getAction())) {
			...
			String path = intent.getStringExtra(MrpRunner.INTENT_KEY_ENTRY_MRP);
			...
			Intent activityIntent = new Intent(MrpRunner.INTENT_ACTION_LAUNCH_MRP);
